...
You can filter which part of the provisioning process to run by specifying a set of tags using `ansible-playbook`'s `--tags` flag. The tags available are `vim`, `dotfiles`, `homebrew`, `mas`, `extra-packages` and `osx`.
